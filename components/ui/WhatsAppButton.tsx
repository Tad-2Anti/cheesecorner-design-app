export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/919489531976?text=Hi!%20I'd%20like%20to%20enquire%20about%20your%20cheeses."
      target="_blank"
    ...
    >
      <svg viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148
          ...
          -.124-.272-.198-.57-.347z"/>
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.132.558 4.13 1.535 5.873L.057
          23.428l5.7-1.493A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627
          0 12 0zm0 21.818a9.818 9.818 0 01-5.034-1.39l-.361-.214-3.741.979
          1.001-3.648-.234-.374A9.818 9.818 0 1112 21.818z"/>
      </svg>
    </a>
  );
}
